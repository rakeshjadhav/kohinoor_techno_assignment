...
```
cd existing_repo
git remote add origin https://gitlab.com/rjwebdev1/kohinoor_techno_assignment.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/rjwebdev1/kohinoor_techno_assignment/-/settings/integrations)
